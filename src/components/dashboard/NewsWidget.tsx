  ...
  return (
    <Card className="zoho-card p-4 md:p-6 h-full">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold text-white">Property News</h3>
      </div>
      {isLoading ? (
            ...
            {articles.map((article, idx) => (
              ...
              >
                <div className="min-w-0 flex-1">
                  <p className="text-sm text-white group-hover:text-primary transition-colors line-clamp-1 truncate">
                    {article.title}
                  </p>
                ...
                <ExternalLink className="w-3.5 h-3.5 shrink-0 text-white/40 group-hover:text-primary transition-colors" />
              </a>
            ))}
          </div>
        </ScrollArea>
